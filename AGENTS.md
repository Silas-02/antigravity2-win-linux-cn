...
- The current localization release is **v2.10.0**, targeting the official **Antigravity v2.10.0** client. The current version dictionary is `dicts/v2.10.0.json`; the localization release, client target, date, support statement, and dictionary name documented in `README.md` must remain consistent.
