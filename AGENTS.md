...
- The current localization release is **v2.9.1.2**, targeting the official **Antigravity v2.9.1** client. The current version dictionary is `dicts/v2.9.1.2.json`; the localization release, client target, date, support statement, and dictionary name documented in `README.md` must remain consistent.
